...
<body>
    ...
    <div class="bienvenido">
        ...
        <h1 class="montserrat-custom"><strong>Bienvenid@: <?php echo $nombreOrganizador; ?></strong></h1>
        <div class="header">
       ...
       <ul class="nav nav-underline">
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="#">Crear Torneo</a></li>
              <li><a class="dropdown-item" href="#">Ver Torneo</a></li>
            </ul>
        <li class="nav-item dropdown">
    ...
    <div class="card-group">
        ...
        <div class="card">
          <a href="https://famm.com.mx/convocatoria/" target="_blank" "><img src="https://i0.wp.com/famm.com.mx/wp-content/uploads/2022/04/campeonato-nacional-artes-marciales-mixtas.jpeg?resize=1187%2C1536&ssl=1" class="card-img-top" alt="..." id="img-not></a>
          <div class="card-body">
