...
<body>
    ...
    <strong>Entrenador, <?php echo htmlspecialchars($_SESSION['usuario']); ?> </strong>
            </a>
        ...
        <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><strong><?php echo htmlspecialchars($_SESSION['usuario']); ?></strong> </h5>
                 ...
                 <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="../entrenador/vistatorneos.php">Torneos</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="card-group">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Fecha: Del 24 al 26 de junio.<br> Sede: Gimnasio Nuevo León Unido</p>
            </div>
            <div class="card-footer">
                <small class="text-body-secondary">Publicado: 17 de mayo de 2024</small>
            </div>
